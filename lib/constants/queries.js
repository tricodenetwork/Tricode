...
export const TALENTS_PROJECTS = `query TalentsProject ($email: String!) {
        projectsByTalent(email: $email) {
            _id
            name
            company
            description
...
export const MYTASKS = `query MyTasks ($name: String!,$id: ID!) {
        mytasks(name: $name,id:$id) {
                  name
                  description
                  status
                  milestone
