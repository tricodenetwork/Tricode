  ...
  return (
    <div>
      <div className="flex flex-col text-black py-2 justify-center">
        ...
        >
          <p className={`text-[15px] md:text-[18.687px] font-bold`}>
            {question}
          </p>
          <div>
            {isOpen ? <img src="/assets/icons/right.svg" className="rotate-[90deg]" alt="" /> : <img src="/assets/icons/right.svg" alt="" />}
          </div>
        </div>

        <div className="flex flex-col text-black justify-center items-center">
          {isOpen && (
            <div className="bg-stone-100 w-[95%] flex flex-col mb-2 p-5 bg-opacity-30 gap-y-34 rounded-md justify-center items-center" id="content">
