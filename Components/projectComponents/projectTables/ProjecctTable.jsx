...
function ProjectTable() {
    ...
    return (
        <section className=" w-[75%] m-auto overflow-y-scroll h-full ">
            <div className="flex justify-between">
                <h2 className={` capitalize  font-bold text-xl mb-2 `}>New project(s)</h2>
                <Link  href={'addnew'} className="font-bold text-green flex gap-3 text-green-600  items-center">
                    <PlusIcon fontSize={32}/> Add New</Link>
            </div>
            <section>
                <Table/>
            </section>
            ...
            <h2 className={` capitalize  font-bold text-xl mb-2 `}>Project History</h2> 
            <TableHistory/>
            </section>
          ...
          <tbody className="text-gray-600 text-sm font-light">
                    {
                        [1,2,3,1,6].map((v, k) => (
                            <tr key={k} className="border-b border-gray-200 hover:bg-gray-100">
                                <td className="py-3 px-6 text-left whitespace-nowrap">{k+1}</td>
                            ...
                            <Link href={'/menu/project/projectID'} className="  border-green-800 font-bold text-green-800  rounded-full border px-8 py-2 my-2">
                                View
                                </Link>
                            </td>
                            </tr>
          ...
          <tbody className="text-gray-600 text-sm font-light">
                    {
                        [1,2,3,1,6].map((v, k) => (
                            ...
                            <td className="py-3 px-6 text-center">
                                <Link href={'/menu/project/projectID'} className="  border-green-800 font-bold text-green-800  rounded-full border px-8 py-2">
                                View
                                </Link>
                            </td>
                            </tr>
