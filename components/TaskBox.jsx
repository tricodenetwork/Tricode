...
const TaskBox = ({
  ...
  return (
    <div className={`w-[30%] ${style}  pt-6 h-[600px]   rounded-3xl`}>
      <h4 className='semiBold w-full mb-6 text-center  text-2xl text-[#1b1b1b]'>
        {heading}
      </h4>
      <div className=' h-[90%] w-full px-6 overflow-y-scroll'>
        {data.map((item) => (
          <div className='h-auto my-4 flex flex-col justify-between w-full shadow-[0px_4px_4px] shadow-black/25 bg-white rounded-[20px] p-6'>
            ...
            <h6 className='text-[#1b1b1b] text-sm Bold mt-[2px] mb-2'>
              {item.milestone ?? "Update documentation based on feedback"}
            </h6>
