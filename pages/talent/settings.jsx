  ...
  return (
    <section className=" ">
        <div className="md:w-[60%] m-auto my-6">
            <h2 className=" text-xl font-bold mb-4">Customize various aspects of your TRICODE {`<Dev/>`} Network experience to suit your preferences.</h2>
            <div>
            ...
            <h2 className=" text font-bold my-6">Please select the main reason for closing your account (Optional)</h2>
            ...
            <div>
                ...
                <div className="flex gap-2 my-4">
                    <input type="checkbox" /><span>Yes, I want to permanently close my Fix my build account and delete my data.</span>
                </div>

                <button className="px-8 p-2 border-binance_green text-binance_green border rounded-full my-4">Close your account</button>
            </div>
