    ...
    <section className=" flex gap-4 flex-col md:flex-row p-4">
        <aside className="w-full md:w-[20%] md:min-h-screen md:border-r md:p-4">
           ...
           <div className="w-full">
                <Link href="/chat/id" className="flex  my-2 items-center justify-between  text-binance_green hover:bg-ash w-full p-2 rounded">
                    ...
                    {
                        [1,1,1,1,1,1].map((_,i)=>(
                            <Link href="/chat/id" key={i} className="flex gap-2 my-2 items-center hover:bg-ash w-full p-2 rounded">
                                <div className="flex gap-2  items-center w-full ">
                               <Image
                                    alt='logo'
                                    width={80}
        ...
        <section className="w-full relative">
         {/* CHAT HEADER */}
            <div className="p-6 border-b flex gap-4 items-center w-full relative ">
                ...
                <div className="w-fit px-4 py-2 bg-ash absolute bottom-[-20%] rounded-full m-auto left-0 right-0">12:01:2024</div>
            </div>
         {/* END CHAT HEADER */}
                    ...
                    <div className=" flex flex-col gap-2 items-end">
                      ...
                      <div className="flex items-end gap-2">
                        ...
                        <div className="p-4 bg-binance_green text-white rounded-md rounded-tr-[0px] my-2  w-fit">
                            <p>Amet minim mollit non deserunt ullamco est sit aliqua dolor do Exercitation veniam consequat sunt nostrud amet.</p>
                        </div>
                      </div>
                      <div className="flex items-end gap-2">
            ...
            <section className=" bg-ash w-full p-4 flex gap-1 items-end my-3">
                        <div className="flex gap-2">
                            <label className="cursor-pointer">
                                ...
                                <input name="file-input" type="file" className=" hidden" id="file-upload" accept="image/*"/>
                            </label>
                            <label className="cursor-pointer">
                                <LuPaperclip className=" text-2xl text-gray-500"/>
                                <input name="file-input" type="file" className=" hidden"  accept="/*"/>
                            </label>
                        ...
                        <div className="p-2 w-full border-b border-gray-800 flex"> 
                            <input value={chat} className="w-full bg-transparent outline-none" placeholder="Type here..." onChange={(e)=>setChat(e.target.value)} />
                            <button tabIndex={0}    ><IoIosSend className=" text-2xl text-binance_green" /></button>
                        </div>
            </section>
        </section>
    </section>
