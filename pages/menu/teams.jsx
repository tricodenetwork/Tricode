 ...
 return(
  <div className="w-[217px] flex flex-col items-center h-[221px] relative">
    ...
    <div className="w-[90%] h-[140px] flex justify-center items-center rounded-[20px] shadow-md shadow-slate-400">
        <img className="w-[88px] mx-auto mt-4 self-center h-[88px]" src={src} alt="team-member" />
    </div>
...
const Teams = () => {
  ...
  //------------------------------------------------------------------USE EFFECTS
  return <div className='h-full w-full flex flex-col  justify-start items-start'>
   ...
   <div className="flex mx-7 mt-8 justify-between w-[90%]">
    ...
    <div className="flex mr-10  items-center">
      <p className="regular text-[#131418] mr-6 text-[12px]">16 Result(s) Found</p>
      <p className="regular text-[#131418] mr-2 text-[14px]">Filter By</p>
      <FilterComponent placeholder={"Latest"} items={["Latest", "Highest", "Level"]}/>
    </div>
    </div>
    ...
    <h6 className="semiBold text-[24px] my-4 text-[#2b2b2b] text-center w-full">FinTechXperience</h6>
    <div className="w-full flex flex-wrap gap-3 justify-center">
      {members.map((member) => {
        return <TeamCard title={member.title} src={member.src}/>
      }
      )}
    </div>
    </section>
