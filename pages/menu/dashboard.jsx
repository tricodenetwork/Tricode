...
const Dashboard = () => {
  ...
  return (
    <div className='h-full  p-5  lg:p-10 w-full  flex flex-col'>
      {upload && (
      ...
      {!true ? (
        <div className='flex flex-col gap-[58px] pl-[4vw] pb-[8vh] justify-around'>
          <div className='flex flex-row justify-between items-end h-max'>
            ...
            <div className='w-full h-max   mt-5 lg:mt-0 lg:w-[45vw]'>
              <div className="[font-family:'Poppins-SemiBold',Helvetica] font-semibold text-black text-[24px] tracking-[0] leading-[normal]">
                Project History
              </div>
              <div className='flex h-max overflow-hidden   justify-center relative  p-8 bg-white rounded-[32px] border-2 border-solid border-[#efeeee items-center mt-10'>
                <table className='w-full   bg-white  rounded'>
                  <thead className='text-black'>
                    <tr className='font-bold text-black  text-sm leading-normal capitalize'>
                      ...
                      <th className='py-5 px-4 hidden lg:flex text-center justify-center whitespace-nowrap'>
                        Initiation Date
                      </th>
                  ...
                  <tbody className=''>
                    {projects?.slice(0, 6).map((v, k) => (
                      ...
                      >
                        ...
                        <td className='py-5 px-0 sm:px-4 hidden lg:flex medium justify-center text-grayText text-base text-center whitespace-nowrap'>
          ...
          <div className='flex items-start  justify-between '>
            <div className='inline-flex mt-5  w-1/2 h-[30vh] flex-col items-start gap-[10px] relative'>
            ...
            <div className='flex w-1/2 h-[30vh] self-start flex-col'>
        ...
        <div className='flex pl-[4vw] pb-[8vh] justify-between'>
          <div className='flex flex-row justify-between items-end h-max'>
            <div className='h-full justify-between flex flex-col'>
              <div>
                <p className='text-transparent text-[20px] tracking-[0] leading-[normal]'>
          ...
          <div className='flex flex-col gap-[39px]'>
            <div className='w-full h-max   mt-5 lg:mt-0 lg:w-[45vw]'>
              <h6 className="[font-family:'Poppins-SemiBold',Helvetica] font-semibold text-black text-[24px] tracking-[0] leading-[normal]">
                Project History
              </h6>
            ...
            <div className='w-full h-max   mt-5 lg:mt-0 lg:w-[45vw]'>
              ...
              <div className='flex h-max overflow-hidden   justify-center relative  p-8 bg-white rounded-[32px] border-2 border-solid border-[#efeeee] items-center mt-5'>
                <div className='w-full   bg-white  rounded'>
                  <div className='font-bold flex w-full  text-black  text-sm leading-normal capitalize'>
                    <p className='py-5 w-[5%]  text-center hidden lg:flex uppercase'>
                      S/N
                    </p>
                    <p className='py-5 w-[30%]   text-center  whitespace-nowrap'>
                      Project Name
                    </p>
                    <p className='py-5  w-[45%] hidden lg:flex text-center justify-center  whitespace-nowrap'>
                      To-Do
                    </p>
                    <p className='py-5 w-[20%] text-center'>ETA</p>
                  </div>
                  <div className=''>
                    {projects?.slice(0, 4).map((v, k) => (
                      <div
                        onClick={() => router.push(`/menu/project/${v._id}`)}
                        key={k.toString()}
                        className='border-b flex hover:cursor-pointer  border-gray-200'
                      >
                        <p className='py-5 w-[5%] medium hidden lg:flex text-grayText text-base text-center whitespace-nowrap'>
                          {k < 9 ? `0${k + 1}` : k + 1}
                        </p>
                        <p className='py-5 w-[30%] sm:px-4 medium text-grayText text-base text-center whitespace-nowrap'>
                          {v.name}
                        </p>
                        <p className='py-5 w-[45%] sm:px-4 hidden lg:flex medium justify-center text-[#455A64] text-base text-center whitespace-nowrap'>
                          Implement API for configurator
                        </p>
                        <p
                          className={`py-5 w-[20%] sm:px-4 medium text-center text-base text-grayText whitespace-nowrap`}
                        >
                          12 Jan, 2024
                        </p>
                      </div>
